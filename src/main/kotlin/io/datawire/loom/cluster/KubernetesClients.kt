...
object KubernetesClients {
    ...
    fun newClient(ctx: ClusterContext): KubernetesClient {
         val config = ConfigBuilder().apply {
            ...
            // If you read the builder code 'username' and 'password' are not used so they're not set regardless of what
